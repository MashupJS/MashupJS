...
mashupApp.config(function ($provide) {
    $provide.decorator("$log", function ($delegate, logService) {
        return logService($delegate);
    });
});

mashupApp.factory("logService", function ($filter, sessionService, utility) {
    "use strict";
            ...
            setInterval(function () {
                ...
                (function wait() {
                    if (logDbReady) {
                        ...
                        var logObject = utility.getLogObject("logManagement:Truncate", "Mashup.UI.Core", "logService", "anonymous:setInterval", null, sessionService);
