...
mashupApp.controller('exApp1.lodashController', function (alertService, mashupExamplesDataService) {
    ...
    vm.example7items_click = function() {
        mashupExamplesDataService.getExample7items(vm.example7items_cache, vm.example7items_done, vm.example7items_contact).then(function(data) {
