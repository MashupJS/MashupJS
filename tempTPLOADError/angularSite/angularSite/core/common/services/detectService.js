...
mashupApp.service('detectService', function ($http, $q, $log, $interval, $filter, $rootScope, utility, sessionService) {
        ...
        setInterval(function () {
            ...
            (function wait() {
                if (logHeartbeatReady) {
                    ...
                    var logObject = utility.getLogObject("detectManagement:Truncate", "MashupCoreUI", "detectService", "anonymous:setInterval", null, sessionService);
    ...
    var recordHeartBeatResult = function (webApiName, result, data) {
        ...
        var logObject = utility.getLogObject("HeartBeat", "MashupCoreUI", "detectService", "recordHeartBeatResult", result, sessionService);
        if (result) {
            logObject.msg = msg;
    ...
    var addToCodeBlueList = function (item) {
        if (!_.where($rootScope.codeBlueList, { 'id': item.id }).length) {
            ...
            if (!codeBlueMonitor) {
                ...
                var logObject = utility.getLogObject("StartCodeBlueMonitor", "MashupCoreUI", "detectService", "addToCodeBlueList", "Starting", sessionService);
    ...
    var startCodeBlueMonitor = function () {
        ...
        codeBlueMonitor = $interval(function () {
            ...
            if ($rootScope.codeBlueList.length === 0) {
                ...
                var logObject = utility.getLogObject("CodeBlueMonitor", "MashupCoreUI", "detectService", "startCodeBlueMonitor", "ended", sessionService);
    ...
    var recordCodeBlueResult = function (webApiName, result, data) {
        ...
        var logObject = utility.getLogObject("CodeBlueMonitor", "MashupCoreUI", "detectService", "recordCodeBlueResult", result, sessionService);
    ...
    var canDetectHeartBeat = function (heartBeatUrl, webApiName) {
        ...
        try {
            ...
            var logObject = utility.getLogObject("CodeBlueMonitor", "MashupCoreUI", "detectService", "canDetectHeartBeat", "Error", sessionService);
            logObject.webApiName = webApiName;
    ...
    return {
        ...
        failed: function (heartBeatUrl, webApiName) {
            ...
            var logObject = utility.getLogObject("CodeBlueMonitor", "MashupCoreUI", "detectService", "detectService.failed", false, sessionService);
            logObject.webApiName = webApiName;
            logObject.heartBeatUrl = heartBeatUrl;
