...
mashupApp.service('cacheService', ['$http', '$q', '$log', 'utility', 'detectService', 'sessionService', function ($http, $q, $log, utility, detectService, sessionService) {
    ...
    isCacheStale('mashCacheStart', minutesInOneWeek).then(function (result) {
        ...
        if (result) {
            ...
            var logObject = utility.getLogObject("mashCasheDelete", "Mashup.UI.Core", "cacheService", "root of cacheService", "Stale-Cache", sessionService);
    ...
    var getHeartBeatUrl = function (webApiUrl, useHeartBeatConvention, heartBeatUrl) {
        ...
        if (useHeartBeatConvention == true) {
            ...
            if (!heartBeatUrl) {
                var logObject = utility.getLogObject("No heartBeatUrl provided", "Mashup.UI.Core", "cacheService", "getHeartBeatUrl", "return blank", sessionService);
                    ...
                    $http.get(webApiUrl, { withCredentials: true })
                        .success(function (data) {
                            ...
                            try {
                                ...
                                var logObject = utility.getLogObject("mashCasheDelete", "Mashup.UI.Core", "cacheService", "getData", "Error", sessionService);
